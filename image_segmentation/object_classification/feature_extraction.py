...
from image_segmentation.constants import TEMP_IMAGE_DIR, CENTROIDS_RGB, BW, SIGMA
...
class ColorSimilarity:
    ...
    ISCC_NBS_CENTROIDS_LUV = cv2.cvtColor(CENTROIDS_RGB, cv2.COLOR_RGB2Luv).reshape(-1, 3)
